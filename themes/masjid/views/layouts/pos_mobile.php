...
<?php $this->beginContent('//layouts/pos_mobile_menu'); ?>
<!--<div id="logo">-->
...
?>
    ...
    <script>
        $(function() {
            ...
            ?>
                $(document).on('click', "#tombol-admin-mode", function() {
                    $(".left-off-canvas-menu").foundation('offcanvas', 'show', 'move-right');
                    $(".admin-input").toggle(500, function() {
                        if ($(".admin-input").is(':visible')) {
                            $("#admin-user").focus();
                            // console.log('admin user focus');
                        } else {
                            $(".left-off-canvas-menu").foundation('offcanvas', 'hide', 'move-right');
                            $("#scan").focus();
                            // console.log('scan focus');
                        }
                    });
