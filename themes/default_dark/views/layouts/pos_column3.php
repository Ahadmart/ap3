...
<div class="medium-2 columns sidebar kiri">
    ...
    <ul class="stack button-group">
        <li><a href="<?php echo $this->createUrl('tambah'); ?>"
                class="expand bigfont tiny button" accesskey="n" id="tombol-new"><span class="ak">N</span>ew</a></li>
        <li><a href="<?php echo $this->createUrl('suspended'); ?>"
                class="expand bigfont tiny info button" accesskey="s"><span class="ak">S</span>uspended</a></li>
        <li><a href="<?php echo $this->createUrl('cekharga'); ?>"
                class="expand bigfont tiny button" accesskey="h">Cek <span class="ak">H</span>arga</a></li>
        <li><a href="<?php echo $this->createUrl('pesanan'); ?>"
                class="expand bigfont tiny info button" accesskey="p"><span class="ak">P</span>esanan (Sales Order)</a>
        </li>
    </ul>
    ...
    <form id="form-nomor-customer">
        <div class="row collapse" id="ganti-customer" style="display: none">
            <div class="small-9 large-10 columns">
                <input type="text" name="nomor-customer" id="nomor-customer" placeholder="Input nomor"
                    autocomplete="off" />
            </div>
    ...
    <form id="form-nomor-member">
        <div class="row collapse" id="ganti-member" style="display: none">
            <div class="small-9 large-10 columns">
                <input type="text" name="nomor-member" id="nomor-member" placeholder="Nomor member"
                    autocomplete="off" />
            </div>
            <div class="small-3 large-2 columns">
    ...
    <div id="data-member">
        ...
        <info><?=is_null($this->memberOnline) ? '' : 'Level: ' . $this->memberOnline->levelNama . ' (Poin: ' . $this->memberOnline->poin . ', Cashback: ' . $this->memberOnline->cb . ')'?></info>
    </div>
...
$posModeAdmin = Yii::app()->user->getState('posModeAdminAlwaysON');
    ...
    <ul class="stack button-group">
        <li><a href=""
                class="expand bigfont tiny <?php echo Yii::app()->user->getState('kasirOtorisasiAdmin') == $this->penjualanId ? 'warning' : ''; ?> button"
                id="tombol-admin-mode" accesskey="m">Mode Ad<span class="ak">m</span>in</a></li>
    </ul>
    <?php
}?>
    <form id="form-akm">
    ...
    <ul class="stack button-group">
        <li><a href="" class="expand bigfont tiny button" id="tombol-akm" accesskey="k">Input A<span
                    class="ak">K</span>M</a></li>
    </ul>
    ...
    <ul class="stack button-group">
        <li><a href="" class="expand bigfont tiny button" id="tombol-pesanan" accesskey="i"><span
                    class="ak">I</span>nput Pesanan</a></li>
    </ul>
    <script>
        $(function() {
