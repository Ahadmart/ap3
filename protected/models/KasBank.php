...
class KasBank extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('kode_akun_id, updated_by', 'length', 'max' => 10),
            array('created_at, updated_at, updated_by', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, nama, kode_akun_id, created_at, updated_at, updated_by', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'kodeAkun' => array(self::BELONGS_TO, 'KodeAkun', 'kode_akun_id'),
