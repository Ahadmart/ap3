 ...
 * @property string $harga_jual_asli
 * @property string $harga_jual_net
...
class PenjualanDiskon extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('penjualan_detail_id, penjualan_id, harga_jual_asli, harga_jual_net, updated_at, updated_by', 'required'),
			array('tipe_diskon_id', 'numerical', 'integerOnly'=>true),
			array('penjualan_detail_id, penjualan_id, updated_by', 'length', 'max'=>10),
			array('harga_jual_asli, harga_jual_net', 'length', 'max'=>18),
			array('created_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, penjualan_detail_id, penjualan_id, harga_jual_asli, harga_jual_net, tipe_diskon_id, updated_at, updated_by, created_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'harga_jual_asli' => 'Harga Jual Asli',
			'harga_jual_net' => 'Harga Jual Net',
	...
	public function search()
	{
		...
		$criteria->compare('harga_jual_asli',$this->harga_jual_asli,true);
		$criteria->compare('harga_jual_net',$this->harga_jual_net,true);
