...
class DiskonBarangMolLevel extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['barang_diskon_id, level, level_nama', 'required'],
            ['barang_diskon_id', 'length', 'max' => 11],
            ['level', 'length', 'max' => 10],
            ['level_nama', 'length', 'max' => 45],
            ['updated_at, created_at, updated_by', 'safe'],
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            ['id, barang_diskon_id, level, level_nama, updated_at, updated_by, created_at', 'safe', 'on' => 'search'],
        ];
    }
