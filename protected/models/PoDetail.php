...
class PoDetail extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['po_id, barcode, nama, harga_beli_terakhir', 'required'],
            ...
            ['nama', 'length', 'max' => 45],
            ['harga_beli_terakhir', 'length', 'max' => 18],
            ['created_at, updated_at, updated_by', 'safe'],
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            ['id, po_id, barang_id, barcode, nama, harga_beli_terakhir, ads, stok, est_sisa_hari, saran_order, qty_order, status, updated_at, updated_by, created_at', 'safe', 'on' => 'search'],
        ];
    }
    ...
    {
        return number_format($this->qty_order * $this->harga_beli_terakhir, 0, ',', '.');
    }
}
