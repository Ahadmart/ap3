...
class RakbarangController extends Controller {
   ...
   public function actionTambah() {
      ...
      if (isset($_POST['RakBarang'])) {
         $model->attributes = $_POST['RakBarang'];
         if ($model->save())
   ...
   public function actionIndex() {
      $model = new RakBarang('search');
      $model->unsetAttributes();  // clear any default values
      if (isset($_GET['RakBarang']))
         $model->attributes = $_GET['RakBarang'];
    ...
    * @param RakBarang $model the model to be validated
    */
   protected function performAjaxValidation($model) {
      if (isset($_POST['ajax']) && $_POST['ajax'] === 'rak-barang-form') {
