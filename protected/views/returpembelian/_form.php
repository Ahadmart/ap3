...
<div class="form">
   ...
   <div class="row">
      <div class="small-12 columns">
         ...
         ?>
         <?php echo $form->error($model, 'supplier_id', ['class' => 'error']); ?>
      </div>
   </div>
   ...
   <script>
      $("#checkbox_profil").change(function() {
         if (this.checked) {
            console.log('semua');
            $("#ReturPembelian_profil_id").load("<?php echo $this->createUrl('ambilprofil', ['tipe' => $this::PROFIL_ALL]); ?>");
         } else {
            console.log('supplier');
            $("#ReturPembelian_profil_id").load("<?php echo $this->createUrl('ambilprofil', ['tipe' => $this::PROFIL_SUPPLIER]); ?>");
         }
      });
   </script>
   <div class="row">
      ...
      <div class="large-6 columns">
         ...
         ?>
         <?php echo $form->textField($model, 'tanggal_referensi', ['class' => 'tanggalan', 'value' => $model->isNewRecord ? date('d-m-Y') : date_format(date_create_from_format('Y-m-d', $model->tanggal_referensi), 'd-m-Y')]); ?>
