...
<div class="form">
    ...
    <div class="row">
        ...
        <div class="small-12 medium-4 large-3 columns">
            ...
            <?php
            echo $form->dropDownList($model, 'kategori_id', CHtml::listData(KategoriPenerimaan::model()->findAll(array('order' => 'nama')), 'id', 'nama'), array(
                'empty' => 'Pilih satu..',
            ));
            ?>
...
<script>
    ...
    function isiProfil(data) {
        ...
        $("#Penerimaan_profil_id").val(data.id);
        $("#Penerimaan_keterangan").focus();
    }
