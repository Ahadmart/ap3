...
<div class="form">
    ...
    <div class="row">
        ...
        <div class="small-12 medium-6 columns">
            ...
            <?php echo $form->dropDownList($model, 'menu_id', Menu::model()->listMenuRoot()); ?>
            <?php echo $form->error($model, 'menu_id', array('class' => 'error')); ?>            
        </div>
    </div>

    <div class="row">
        <div class="small-12 columns">
            <?php echo CHtml::submitButton($model->isNewRecord ? 'Tambah' : 'Simpan', array('class' => 'tiny bigfont right button')); ?>
        </div>
    </div>
