...
<?php echo $form->hiddenField($model, 'itemKeuId'); ?>
<div class="row">
    ...
    <div class="medium-6 large-4 columns">
        <div class="row collapse">
            <label>Item Keu</label>
            <div class="small-9 columns">
                <?php echo CHtml::textField('itemKeu', empty($model->itemKeuId) ? '' : $model->namaItemKeu, ['size' => 60, 'maxlength' => 500, 'disabled' => 'disabled']); ?>
            </div>
            <div class="small-3 columns">
                <a class="tiny bigfont button postfix" id="tombol-browse-itemkeu" accesskey="h">Pili<span class="ak">h</span>..</a>
            </div>
        </div>
    </div>
    <div class="medium-6 large-4 columns">
