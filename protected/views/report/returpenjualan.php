...
$this->boxHeader['small'] = 'Retur Jual';
$this->boxHeader['normal'] = '<i class="fa fa-database fa-lg"></i> Laporan Retur Penjualan';

$this->renderPartial('_form_retur_penjualan', array('model' => $model));
?>
<div class="row">
    ...
    <div class="row">
        <div class="small-12 columns">
            <table class="tabel-index responsive">
                ...
                <tbody>
                    <?php
                    $statusRetur = ReturPenjualan::listStatus();
                    $i = 1;
                    foreach ($report['detail'] as $barisReport):
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo Yii::app()->createUrl('returpenjualan/view', array('id' => $barisReport['id'])); ?>"><?php echo $barisReport['nomor']; ?></a></td>
...
<script>
    ...
    function isiProfil(data) {
        ...
        $("#ReportReturPenjualanForm_profilId").val(data.id);
    }
    ...
    function isiUser(data) {
        ...
        $("#ReportReturPenjualanForm_userId").val(data.id);
    }
