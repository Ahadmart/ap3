            ...
            ?>
                ...
                ?>
                    ...
                    <ul>
                        ...
                        ?>
                            <li><a target="blank" href="<?= $this->createUrl('printpenjualan', [
                                                            'printId' => $printer['id'],
                                                            'kertas'  => $key,
                                                        ]) ?>"><?= $value; ?></a></li>
                        <?php
                ...
                ?>
                    <li>
                        <a class="tombol-print-pembelian" href="<?= $this->createUrl($printHandle, [
                                                                    'printId' => $printer['id'],
                                                                ]) ?>">
...
<script>
    $(".tombol-print-pembelian").on("click", function(e) {
        e.preventDefault();
        var link = $(this).attr("href");
        var formParam = $("#report-pembelian-form").serialize();
        window.location.href = link + "&" + formParam;
    })
</script>