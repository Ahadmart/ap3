...
/* @var $model ReportPenjualanPerKategoriForm */
...
<div class="row">
    <div class="small-12 medium-4 large-2 columns">
        ...
        <?php echo $form->textField($model, 'dari', ['class' => 'tanggalan', 'value' => empty($model->dari) ? date('d-m-Y') : $model->dari]); ?>
        <?php echo $form->error($model, 'dari', ['class' => 'error']); ?>
    </div>
    <div class="small-12 medium-4 large-2 columns">
        <?php echo $form->labelEx($model, 'sampai'); ?>
        <?php echo $form->textField($model, 'sampai', ['class' => 'tanggalan', 'value' => empty($model->sampai) ? date('d-m-Y') : $model->sampai]); ?>
