    ...
    <div class="small-12 medium-6 medium-offset-3 large-6 large-offset-3 columns">
        <div class="block">
            <div class="top-bar block-header">
                <ul class="title-area">
                    <li class="name" style="margin: 6px 15px">
                        <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/logo-login.png" />
                    </li>
                </ul>
                <section class="top-bar-section">
                    <ul class="right" id="">
                        <!--<li class="divider"><span></span></li>-->
                        <li class="not-click"><a><i class="fa fa-sign-in fa-fw fa-lg"></i> LOGIN</a></li>
                    </ul>
                </section>
            </div>
