...
<div class="form">
    ...
    <div class="row">
        <div class="small-12 columns">
            ...
            <?php
            echo $form->dropDownList($model, 'parent_id', CHtml::listData(ItemKeuangan::model()->findAll('jenis=' . ItemKeuangan::ITEM_PENERIMAAN . ' and parent_id is null'), 'id', 'nama'), array(
                'empty' => 'Pilih satu..'
            ));
            ?>
